...
def nine_slice(args, path:, x1:, x2:, y1:, y2:, w:, h:, output_x:, output_y:, output_w:, output_h:)
  ...
  lower_right_slice = {x: x2, y: y2, w: h - x2, h: h - y2}
  ...
  args.outputs.sprites << {x:output_x + middle_left_slice.w, y:middle_y, w:output_w - middle_left_slice.w - middle_right_slice.w, h:output_h - upper_middle_slice.h - lower_middle_slice.h, path:path, tile_x:middle_left_slice.w, tile_y:middle_left_slice.h, tile_w:middle_middle_slice.w, tile_h:middle_middle_slice.h}
